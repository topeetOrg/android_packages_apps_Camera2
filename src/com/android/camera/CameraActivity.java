...
public class CameraActivity extends Activity
    ...
    public void onPause() {
        ...
        Log.v(TAG, "call onPauseAfterSuper)#####");
    ...
    public void onModuleSelected(int moduleIndex) {
        ...
        Log.v(TAG, "onModuleSelected start #####");

        CameraHolder.instance().keep();
        closeModule(mCurrentModule);
        setModuleFromIndex(moduleIndex);

         Log.v(TAG, "onModuleSelected middle #####");
        ...
        Log.v(TAG, "onModuleSelected end #####");
    }
    ...
    private void closeModule(CameraModule module) {
       ...
       Log.v(TAG, "call onPauseAfterSuper  <- closeModule #####");
        module.onPauseAfterSuper();
        ((ViewGroup) mCameraModuleRootView).removeAllViews();

      Log.v(TAG, "call onPauseAfterSuper  <- closeModule  end #####");
    }
