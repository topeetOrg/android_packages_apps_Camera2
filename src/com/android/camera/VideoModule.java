...
public class VideoModule implements CameraModule,
    ...
    private void getDesiredPreviewSize() {
        ...
        if (mParameters.getSupportedVideoSizes() == null) {
            ...
            Log.v(TAG, "getDesiredPreviewSize########Start");

            List<Size> sizes = mParameters.getSupportedPreviewSizes();
/*
            Log.v(TAG, "getDesiredPreviewSize########.......######");

            Size preferred = mParameters.getPreferredPreviewSizeForVideo();
            int product = preferred.width * preferred.height;

            Log.v(TAG, "getDesiredPreviewSize########preferred.width="+preferred.width+"preferred height"+ preferred.height);
...
*/
          ...
          Log.v(TAG, "getDesiredPreviewSize########optimalSize.width="+optimalSize.width+"optimalSize height"+ optimalSize.height);
